...
?>
            ...
            <div class="frm_otp_verification_wrapper">
                ...
                <button type="button" id="send_otp_button" class="frm_button fev-mt-3">Send OTP</button>
                <div id="otp_input_wrapper" style="display:none;">
                    <input type="text" id="otp_input" placeholder="Enter OTP" class="frm_input fev-mt-3" />
                    <button type="button" id="verify_otp_button" class="frm_button fev-mt-3">Verify OTP</button>
                </div>
