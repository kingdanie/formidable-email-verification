...
class FormidableEmailVerification
{
    ...
    {
        wp_register_script('formidable-email-verification', plugin_dir_url(__FILE__) . 'includes/js/formidable-email-verification.js', array('jquery'), '1.0', true);
    ...
    public function send_email_otp()
    {
        ...
        $subject = 'Email Verification Required to Complete Your Voting Process';
        ...
        <body>
            <div class='container'>
                ...
                <div class='content'>
                    ...
                    <p>To maintain the integrity and security of our voting process, we require all voters to verify their email addresses. This step helps us prevent spammers and ensure that each vote is cast only once.</p>
